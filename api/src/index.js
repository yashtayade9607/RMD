...
// Ensure proper indexes and clean presence state
try {
  ...
  app.log.info("[DB] Indexes verified & presence state initialized successfully ✓");
} catch (indexErr) {
  app.log.warn(`[DB] Index/presence setup warning: ${indexErr.message}`);
}
